...
|  17 | 氏名（フリガナ）           | TXBKEIYAKUSYO__SIMEI_KANA       |      |          | 就業者情報.姓カナ <br>就業者情報.名カナ**TODO**外国人名の場合 |
|  18 | 氏名                       | TXBKEIYAKUSYO_SIMEI             |      |          | 就業者情報.姓 <br>就業者情報.名**TODO**外国人名の場合         |
|  19 | 部署名                     | APR_GRP_2-A                     |      |          | -                                                             |
|  20 | 役職名                     | TXBKEIYAKUSYO_YAKUSYOKUMEI      |      |          | -                                                             |
|  21 | 承認者名氏名               | APR_NAME_2-A                    |      |          | -                                                             |
|  22 | 契約期間（開始）           | TXBKEIYAKUSYO_KEIYAKUKIKAN_KAIS |      |          | -                                                             |
|  23 | 契約期間（終わり）         | TXBKEIYAKUSYO_KEIYAKUKIKAN_OWAR |      |          | -                                                             |
...
|  54 | 生年月日                   | TXBKEIYAKSYO_SEINENGAPPI        |      |          | -                                                             |
...
|  19 | 契約期間（開始）              | TXBKEIYAKUSYO_KEIYAKUKIKAN_KAIS |      |          | -                                                         |
|  20 | 契約期間（終わり）            | TXBKEIYAKUSYO_KEIYAKUKIKAN_OWAR |      |          | -                                                         |
...
| --: | :------------------------------------------- | :--------------------------- | :--- | :------- | :----------------------------------------------------- |
|   1 | 日付                                         | APL_DATE-A                   |      |          |                                                        |
|   2 | 申請部署                                     | APL_GRP-A                    |      |          | 就業者所属情報.グループ名称（要員情報 所属部署を優先） |
|   3 | 社員番号                                     | APL_EMP_ID-A                 |      |          | -                                                      |
|   4 | 氏名                                         | APL_NAME-A                   |      |          | -                                                      |
|   5 | 連絡先（内線番号）                           | TXBRENRAKUSAKI               |      |          | -                                                      |
|   6 | 申請区分                                     | CMBSINSEIKUBUN               |      |          |                                                        |
...
|  11 | 要員情報　所属部署                           | CMBYOUINJOUHOU_BUSYO         | 文字 |          | 就業者所属情報.グループ名称                            |
|  12 | 要員情報　勤務先                             | TXBKINMUSAKI                 | 文字 |          |                                                        |
...
|  27 | 備考                                         | TXBBIKOU                     | 文字 |          | 就業者情報.メールアドレス                              |
|  28 | 未使用                                       | BUSYO                        |      |          |                                                        |
...
|  24 | メールアドレス                               | TXBMELUADRESU                   |      |          | 就業者情報.メールアドレス                              |
